...
export function InfrastructureDashboard() {
  ...
  const getStatusMessage = () => {
    ...
    if (infrastructure.avg_health_score >= 70) return { text: 'Systems operational with minor issues', icon: CheckCircle2, color: 'text-sk-blue' };
    ...
    <div className="flex-1 overflow-y-auto p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="rounded-xl border bg-card p-5">
            <div className="flex items-center gap-2 mb-3">
              <div className="w-8 h-8 rounded-lg bg-sk-blue/10 flex items-center justify-center">
                <Mail className="h-4 w-4 text-sk-blue" />
              </div>
